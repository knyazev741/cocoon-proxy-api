...
<execution_context>
@/root/cocoon-api-proxy/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @/root/cocoon-api-proxy/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
