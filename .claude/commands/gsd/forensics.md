...
<execution_context>
@/root/cocoon-api-proxy/.claude/get-shit-done/workflows/forensics.md
</execution_context>
...
<process>
Read and execute the forensics workflow from @/root/cocoon-api-proxy/.claude/get-shit-done/workflows/forensics.md end-to-end.
</process>
