...
<execution_context>
@/root/cocoon-api-proxy/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/root/cocoon-api-proxy/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
