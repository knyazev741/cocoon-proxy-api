...
<execution_context>
@/root/cocoon-api-proxy/.claude/get-shit-done/workflows/new-workspace.md
@/root/cocoon-api-proxy/.claude/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @/root/cocoon-api-proxy/.claude/get-shit-done/workflows/new-workspace.md end-to-end.
