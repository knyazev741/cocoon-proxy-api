...
Use template from `/root/cocoon-api-proxy/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/root/cocoon-api-proxy/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/root/cocoon-api-proxy/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
