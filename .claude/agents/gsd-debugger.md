...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.claude
                  → checks /root/cocoon-api-proxy/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /root/cocoon-api-proxy/.claude/get-shit-done
                  → writes to /root/cocoon-api-proxy/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/root/cocoon-api-proxy/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/root/cocoon-api-proxy/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/root/cocoon-api-proxy/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
