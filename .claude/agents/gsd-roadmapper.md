...
Reference full template: `/root/cocoon-api-proxy/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/root/cocoon-api-proxy/.claude/get-shit-done/templates/state.md`.
