...
See /root/cocoon-api-proxy/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /root/cocoon-api-proxy/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /root/cocoon-api-proxy/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /root/cocoon-api-proxy/.claude/get-shit-done/templates/discovery.md
...
Use /root/cocoon-api-proxy/.claude/get-shit-done/templates/discovery.md.
