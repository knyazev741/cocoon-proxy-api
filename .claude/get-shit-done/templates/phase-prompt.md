...
<!-- For checkpoint task examples and patterns, see @/root/cocoon-api-proxy/.claude/get-shit-done/references/checkpoints.md -->
...
See `/root/cocoon-api-proxy/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/root/cocoon-api-proxy/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/root/cocoon-api-proxy/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
